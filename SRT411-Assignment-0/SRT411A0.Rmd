...
#### Class Document - https://open.senecacollege.ca/cms/mod/resource/view.php?id=49973

## Some first examples of R commands
...
####l <- annotate("info", label = "Footnote", colour = black)
####l